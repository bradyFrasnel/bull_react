      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <button style={styles.cardButton} onClick={() => navigate('/secretariat/students')}>
              Gérer les étudiants
            </button>
          </div>
          ...
          <div style={styles.card}>
            ...
            <button style={styles.cardButton} onClick={() => navigate('/secretariat/enseignants')}>
          ...
          <div style={styles.card}>
            ...
            <button style={styles.cardButton} onClick={() => navigate('/secretariat/subjects')}>
          ...
          <div style={styles.card}>
            ...
            <button style={styles.cardButton} onClick={() => navigate('/secretariat/evaluations')}>
              Voir les évaluations
            </button>
          </div>

          <div style={styles.card}>
            <h3>Gestion Absences</h3>
            <p>Suivi des absences des étudiants</p>
            <button style={styles.cardButton} onClick={() => navigate('/secretariat/absences')}>
              Gérer les absences
            </button>
          </div>
